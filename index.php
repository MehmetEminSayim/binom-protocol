                              ...
                              <div class="header-wrap">
                                   ...
                                   <div class="header-logo logo animated" data-animate="fadeInDown" data-delay=".65">
                                        <a href="./" class="logo-link">
                                             <img class="logo-dark" src="./assets/images/logo.png" srcset="./assets/images/logo2x.png 2x" alt="logo">
                                             <img class="logo-light" src="./assets/images/logo-full-white.png" srcset="./assets/images/logo-full-white2x.png 2x" alt="logo">
                                        </a>
                                   </div>
                                   ...
                                   <div class="header-navbar header-navbar-s2">
                                        <nav class="header-menu justify-content-between" id="header-menu">
                                             ...
                                             <ul class="menu-btns align-items-center animated remove-animation" data-animate="fadeInDown" data-delay=".85">
                                                  ...
                                                  <li><a href="#contact" class="btn btn-rg btn-secondary no-change"><span>Buy Token</span></a></li>
                                             </ul>
                                        </nav>
                                   </div><!-- .header-navbar @e -->
                              </div>
                                                  ...
                                                  <div class="col-lg-6 col-xl-6 text-center text-lg-left">
                                                       <div class="banner-caption tc-light">
                                                            <div class="cpn-head mt-0">
                                                                 <h1 class="title title-thin title-xl-2 animated" data-animate="fadeInUp" data-delay="1.25">Alpiiiii &amp; Blockchain Solutions for Crypto-Trading and Protect your Investments</h1>
                                                            </div>
                                   ...
                                   <div class="row align-items-center flex-row-reverse gutter-vr-30px">
                                        <div class="col-lg-5">
                                             <div class="gfx py-4 mx-auto mx-lg-0 animated" data-animate="fadeInUp" data-delay=".1">
                                                  <img src="./assets/images/salvia/gfx-i.png" alt="gfx">
                                             </div>
                                        </div><!-- .col -->
                                        <div class="col-lg-7">
                                             <!-- Section Head @s -->
                         ...
                         <div class="container">
                              ...
                              <div class="nk-block nk-block-features-s2">
                                   <div class="row align-items-center gutter-vr-30px">
                                        <div class="col-lg-6">
                                             <div class="gfx py-4 mx-auto mx-lg-0 animated" data-animate="fadeInUp" data-delay=".1">
                                                  <img src="./assets/images/salvia/gfx-j.png" alt="gfx">
                                             </div>
                                        </div><!-- .col -->
                                        <div class="col-lg-6">
                                   ...
                                   <div class="row align-items-center flex-row-reverse justify-content-between gutter-vr-30px">
                                        <div class="col-lg-7">
                                             <div class="gfx gfx-auto mb-lg-3 animated" data-animate="fadeInUp" data-delay=".1">
                                                  <img src="./assets/images/app-screens/sc-large-k.png" alt="gfx">
                                             </div>
                                        </div><!-- .col -->
                                        <div class="col-lg-4">
                                             <!-- Section Head @s -->
                                   ...
                                   <div class="row">
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="feature feature-document animated" data-animate="fadeInUp" data-delay=".3">
                                                  <div class="feature-document-img">
                                                       <img src="./assets/images/salvia/docs-sm-a.jpg" alt="">
                                                  </div>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="feature feature-document animated" data-animate="fadeInUp" data-delay=".4">
                                                  <div class="feature-document-img">
                                                       <img src="./assets/images/salvia/docs-sm-b.jpg" alt="">
                                                  </div>
                                                  <div class="feature-document-text">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="feature feature-document animated" data-animate="fadeInUp" data-delay=".5">
                                                  <div class="feature-document-img">
                                                       <img src="./assets/images/salvia/docs-sm-c.jpg" alt="">
                                                  </div>
                                                  <div class="feature-document-text">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="feature feature-document animated" data-animate="fadeInUp" data-delay=".6">
                                                  <div class="feature-document-img">
                                                       <img src="./assets/images/salvia/docs-sm-d.jpg" alt="">
                                                  </div>
                                                  <div class="feature-document-text">
                                   ...
                                   <div class="row justify-content-center gutter-vr-30px">
                                        <div class="col-lg-5 animated" data-animate="fadeInUp" data-delay=".3">
                                             <a href="#" class="product-box">
                                                  ...
                                                  <div class="product-image"><img src="./assets/images/products/c.jpg" alt="prdouct"></div>
                                             </a>
                                        </div>
                                        <div class="col-lg-5 animated" data-animate="fadeInUp" data-delay=".4">
                                             <a href="#" class="product-box">
                                                  <h5 class="product-name">Admin DASHDOARD</h5>
                                                  <div class="product-image"><img src="./assets/images/products/d.jpg" alt="prdouct"></div>
                                             </a>
                                        </div>
                                   </div><!-- .row -->
                              </div><!-- .block @e -->
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="team animated" data-animate="fadeInUp" data-delay=".3">
                                                  <div class="team-photo team-photo-s2">
                                                       ...
                                                       <img src="./assets/images/team/md-a-color.jpg" alt="team">
                                                  ...
                                                  <div class="row align-items-start">
                                                       <div class="col-md-6">
                                                            <div class="team-photo">
                                                                 <img src="./assets/images/team/a-color.jpg" alt="team">
                                                            </div>
                                                       </div><!-- .col  -->
                                                       <div class="col-md-6">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="team animated" data-animate="fadeInUp" data-delay=".4">
                                                  <div class="team-photo team-photo-s2">
                                                       ...
                                                       <img src="./assets/images/team/md-b-color.jpg" alt="team">
                                                       <ul class="team-social">
                                                            <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                                                            <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                                       </ul>
                                             ...
                                             <div id="team-popup-2" class="team-popup mfp-hide">
                                                  ...
                                                  <div class="row align-items-start">
                                                       <div class="col-md-6">
                                                            <div class="team-photo">
                                                                 <img src="./assets/images/team/b-color.jpg" alt="team">
                                                            </div>
                                                       </div><!-- .col  -->
                                                       <div class="col-md-6">
                                                            <div class="team-popup-info pl-md-3">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="team animated" data-animate="fadeInUp" data-delay=".5">
                                                  <div class="team-photo team-photo-s2">
                                                       ...
                                                       <img src="./assets/images/team/md-c-color.jpg" alt="team">
                                                       <ul class="team-social">
                                                            <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                                                            <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                                       </ul>
                                             ...
                                             <div id="team-popup-3" class="team-popup mfp-hide">
                                                  ...
                                                  <div class="row align-items-start">
                                                       <div class="col-md-6">
                                                            <div class="team-photo">
                                                                 <img src="./assets/images/team/c-color.jpg" alt="team">
                                                            </div>
                                                       </div><!-- .col  -->
                                                       <div class="col-md-6">
                                                            <div class="team-popup-info pl-md-3">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="team animated" data-animate="fadeInUp" data-delay=".6">
                                                  <div class="team-photo team-photo-s2">
                                                       ...
                                                       <img src="./assets/images/team/md-d-color.jpg" alt="team">
                                                       <ul class="team-social">
                                                            <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                                                            <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                                       </ul>
                                             ...
                                             <div id="team-popup-4" class="team-popup mfp-hide">
                                                  ...
                                                  <div class="row align-items-start">
                                                       <div class="col-md-6">
                                                            <div class="team-photo">
                                                                 <img src="./assets/images/team/d-color.jpg" alt="team">
                                                            </div>
                                                       </div><!-- .col  -->
                                                       <div class="col-md-6">
                                                            <div class="team-popup-info pl-md-3">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="team animated" data-animate="fadeInUp" data-delay=".8">
                                                  <div class="team-photo team-photo-s2">
                                                       ...
                                                       <img src="./assets/images/team/md-e-color.jpg" alt="team">
                                                       <ul class="team-social">
                                                            <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                                                            <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                                       </ul>
                                             ...
                                             <div id="team-popup-5" class="team-popup mfp-hide">
                                                  ...
                                                  <div class="row align-items-start">
                                                       <div class="col-md-6">
                                                            <div class="team-photo">
                                                                 <img src="./assets/images/team/e-color.jpg" alt="team">
                                                            </div>
                                                       </div><!-- .col  -->
                                                       <div class="col-md-6">
                                                            <div class="team-popup-info pl-md-3">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="team animated" data-animate="fadeInUp" data-delay=".9">
                                                  <div class="team-photo team-photo-s2">
                                                       ...
                                                       <img src="./assets/images/team/md-f-color.jpg" alt="team">
                                                       <ul class="team-social">
                                                            <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                                                            <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                                       </ul>
                                             ...
                                             <div id="team-popup-6" class="team-popup mfp-hide">
                                                  ...
                                                  <div class="row align-items-start">
                                                       <div class="col-md-6">
                                                            <div class="team-photo">
                                                                 <img src="./assets/images/team/f-color.jpg" alt="team">
                                                            </div>
                                                       </div><!-- .col  -->
                                                       <div class="col-md-6">
                                                            <div class="team-popup-info pl-md-3">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                             <div class="team animated" data-animate="fadeInUp" data-delay="1">
                                                  <div class="team-photo team-photo-s2">
                                                       ...
                                                       <img src="./assets/images/team/md-g-color.jpg" alt="team">
                                                       <ul class="team-social">
                                                            <li><a href="#"><em class="fab fa-linkedin-in"></em></a></li>
                                                            <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                                       </ul>
                                             ...
                                             <div id="team-popup-7" class="team-popup mfp-hide">
                                                  ...
                                                  <div class="row align-items-start">
                                                       <div class="col-md-6">
                                                            <div class="team-photo">
                                                                 <img src="./assets/images/team/g-color.jpg" alt="team">
                                                            </div>
                                                       </div><!-- .col  -->
                                                       <div class="col-md-6">
                                                            <div class="team-popup-info pl-md-3">
                                        ...
                                        <div class="col-lg-7">
                                             <div class="bg-light round animated" data-animate="fadeInUp" data-delay=".6">
                                                  <form id="frmdata" method="post">
                                                       ...
                                                       <div class="field-item field-item-s2">
                                                            <input name="contact-surname" type="text" class="input-bordered input-bordered-lg input-bordered-light required" placeholder="Your Surname">
                                                       </div>
                                                       <div class="field-item field-item-s2">
                                                       ...
                                                       <div class="row">
                                                            <div class="col-sm-12">
                                                                 <button type="submit" name="sbtbutton" id="sbtbutton" class="btn btn-md btn-primary">Submit</button>
                                                            </div>
                                                            <div class="col-sm-12">
                         ...
                         <div class="container">
                              ...
                              <div class="nk-block block-partners">
                                   ...
                                   <ul class="partner-list flex-lg-nowrap mgb-m30">
                                        <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".15"><img src="./assets/images/partners/a-xs.png" alt="partner"></li>
                                        <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".2"><img src="./assets/images/partners/b-xs.png" alt="partner"></li>
                                        <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".25"><img src="./assets/images/partners/c-xs.png" alt="partner"></li>
                                        <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".3"><img src="./assets/images/partners/d-xs.png" alt="partner"></li>
                                        <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".35"><img src="./assets/images/partners/e-xs.png" alt="partner"></li>
                                        <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".4"><img src="./assets/images/partners/f-xs.png" alt="partner"></li>
                                   </ul>
                              </div>
                              <!-- Block @e -->
                         </div>
               ...
               <script>
                    $(document).ready(function() {
                         ...
                         $("#sbtbutton").click(function(e) {
                              ...
                              $.ajax({
                                   type: "post",
                                   url: "actions/createCustomer.php",
                                   data: $("form").serialize(),
